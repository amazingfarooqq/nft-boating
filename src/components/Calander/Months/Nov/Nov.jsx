...
import { November, getMinted } from "../../../../hooks/GetMinted";
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="head ">
          <h3 className="card heading">November</h3>
